    ...
    calculateFireTiles() {
        ...
        dragons.forEach(d => {
            ...
            for (let i = 1; i <= 3; i++) {
                ...
                if ([TILE.WARP, TILE.GLASS, TILE.SPRING, TILE.DRAGON, TILE.FIRE_BUTTON].includes(tile)) break;
